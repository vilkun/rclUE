...
#include "Srvs/ROS2SetInt32Srv.h"
...
void UROS2SetInt32Srv::SetRequest(const FROSSetInt32_Request& Request)
{
    Request.SetROS2(SetInt32_req);
}

void UROS2SetInt32Srv::GetRequest(FROSSetInt32_Request& Request) const
{
    Request.SetFromROS2(SetInt32_req);
}

void UROS2SetInt32Srv::SetResponse(const FROSSetInt32_Response& Response)
{
    Response.SetROS2(SetInt32_res);
}

void UROS2SetInt32Srv::GetResponse(FROSSetInt32_Response& Response) const
{
