...
// This code has been autogenerated from UE_msgs/GetInt32FromId.srv - do not modify
...
#include "ROS2GetInt32FromIdSrv.generated.h"

// potential problem: if this struct is defined multiple times!
USTRUCT(Blueprintable)
struct RCLUE_API FROSGetInt32FromId_Request
{
	GENERATED_BODY()
...
USTRUCT(Blueprintable)
struct RCLUE_API FROSGetInt32FromId_Response
{
	GENERATED_BODY()
...
public:
	...
	// used by client
  	UFUNCTION(BlueprintCallable)
	void SetRequest(const FROSGetInt32FromId_Request& Request);
	
	// used by service
  	UFUNCTION(BlueprintCallable)
	void GetRequest(FROSGetInt32FromId_Request& Request) const;
	
	// used by service
  	UFUNCTION(BlueprintCallable)
	void SetResponse(const FROSGetInt32FromId_Response& Response);
	
	// used by client
  	UFUNCTION(BlueprintCallable)
	void GetResponse(FROSGetInt32FromId_Response& Response) const;
